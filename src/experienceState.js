export const PHASE = Object.freeze({
  ...
  ENTITY_RETREAT: 'ENTITY_RETREAT',
  SIGNAL_LOST: 'SIGNAL_LOST',
  TRANSMISSION_ARCHIVED: 'TRANSMISSION_ARCHIVED',
});
...
const ALLOWED_TRANSITIONS = Object.freeze({
  ...
  [PHASE.CONTACT_ACKNOWLEDGED]: [PHASE.ENTITY_RETREAT],
  [PHASE.ENTITY_RETREAT]: [PHASE.SIGNAL_LOST],
  [PHASE.SIGNAL_LOST]: [PHASE.TRANSMISSION_ARCHIVED],
